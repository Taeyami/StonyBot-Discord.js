module.exports = function(file) {
    ...
    if (!db) db = new Database(file || "./nippy.sqlite");
    var methods = {
    ...
    module = {
        ...
        fetch: function (key, ops) {
            if (!key)
                throw new TypeError(
                    "No key specified. Need Help? Check Out: https://discord.gg/GCq3jSkXCN"
                );
        ...
        get: function (key, ops) {
            if (!key)
                throw new TypeError(
                    "No key specified. Need Help? Check Out: discord.gg/GCq3jSkXCN"
                );
            return arbitrate("fetch", { id: key, ops: ops || {} });
        },
        ...
        set: function (key, value, ops) {
            ...
            if (value === undefined)
                throw new TypeError(
                    "No value specified. Need Help? Check Out: discord.gg/GCq3jSkXCN"
                );
        ...
        add: function (key, value, ops) {
            ...
            if (isNaN(value))
                throw new TypeError(
                    "Must specify value to add. Need Help? Check Out: discord.gg/GCq3jSkXCN"
                );
        ...
        push: function (key, value, ops) {
            ...
            if (!value && value != 0)
                throw new TypeError(
                    "Must specify value to push. Need Help? Check Out: discord.gg/GCq3jSkXCN"
                );
        ...
        table: function (tableName, options = {}) {
            if (typeof tableName !== "string")
                throw new TypeError(
                    "Table name has to be a string. Need Help? Check out: discord.gg/GCq3jSkXCN"
                );
            else if (tableName.includes(" "))
                throw new TypeError(
                    "Table name cannot include spaces. Need Help? Check out: discord.gg/GCq3jSkXCN"
                );
